...
vector<double> edecay(int events, vector<vector<double>> neutron_vector, vector<vector<double>> fragment_vector){
    vector<double> edecay;

    for (int i=0; i<events; i++){
        double edecay_val = pow(pow(m_fragment,2)+pow(m_neutron,2)+2*(neutron_vector[i][3]*fragment_vector[i][3]-(neutron_vector[i][0]*fragment_vector[i][0]+neutron_vector[i][1]*fragment_vector[i][1]+neutron_vector[i][2]*fragment_vector[i][2])),0.5)-m_fragment-m_neutron;
        edecay.push_back(edecay_val);
    }
    return edecay;
}
...
//    double amu = 931.49410242 ;// atomic mass in MeV/c^2 (NIST)
//    double m_neutron = 1.00866491590 * amu  ;/// neutron amu mass from in MeV/c^2 (AME2020) (0.000000000047 - sigma)
//    double m_fragment = 51.963213646 * amu  ;/// Ca-52 fragment mass in MeV/c^2 (AME2020)(0.000000720 - sigma)
//    double m_parent = 52.968451000 * amu ;/// Ca-53 fragment mass in MeV/c^2 (AME2020) (0.000047000 - sigma)
//    double m_beam =  53.963029359 * amu ;/// Sc-54 secondary beam mass in MeV/c^2 (AME2020) (0.000015000 - sigma)
//    double m_ex_neutron = 8071.31806/1000  ;/// neutron mass excess in MeV (AME2020) (0.00044 - sigma)
//    double m_ex_fragment = -34266.272/1000  ;/// Ca-52 mass excess in MeV (AME2020) (0.671 - sigma)
//    double m_ex_parent = -29387.707/1000 ;/// Ca-53 mass excess in MeV (AME2020) (43.780 - sigma)
//    double m_ex_beam =  -34437.934/1000 ;/// Sc-54 mass excess in MeV (AME2020) (13.973 - sigma)
